...
class Road(Base):
    ...
    road_geom = GeometryColumn(LineString(2, srid=4326), comparator = GeoDBComparator, nullable=False)
...
class Lake(Base):
    ...
    lake_geom = GeometryColumn(Polygon(2, srid=4326, spatial_index=False), comparator = GeoDBComparator)
